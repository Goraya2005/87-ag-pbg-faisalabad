...
function PastEventDays() {
  ...
  return (
    <div className="max-w-6xl mx-auto grid gap-8 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 items-center lg:max-w-none">
      ...
      {/* Event Date Block */}
      <div className="flex flex-col h-full p-6 bg-brown-800 text-center justify-center" data-aos="fade-up">
      ...
      {/* Time Passed Block */}
      <div className="flex flex-col h-full p-6 bg-red-800 text-center justify-center" data-aos="fade-up" data-aos-delay="200">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 justify-items-center">
          <div className="time-block">
            <p className="text-4xl font-bold">{timePassed.yearsPassed}</p>
            <p className="text-sm">Years</p>
          </div>
          <div className="time-block">
            <p className="text-4xl font-bold">{timePassed.monthsPassed}</p>
            <p className="text-sm">Months</p>
          </div>
          <div className="time-block">
            <p className="text-4xl font-bold">{timePassed.daysPassed}</p>
            <p className="text-sm">Days</p>
          </div>
          <div className="time-block">
            <p className="text-4xl font-bold">{timePassed.hoursPassed}</p>
            <p className="text-sm">Hours</p>
          </div>
          <div className="time-block">
            <p className="text-4xl font-bold">{timePassed.minutesPassed}</p>
            <p className="text-sm">Minutes</p>
          </div>
          <div className="time-block">
            <p className="text-4xl font-bold">{timePassed.secondsPassed}</p>
